...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white min-h-screen">
            ...
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-8">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3">
                        <img src="{{ asset('photos/breakroom.png') }}" alt="Breakroom Logo" class="h-12 w-12 rounded-lg object-contain"/>
                        <span class="text-2xl font-bold bg-gradient-to-r from-yellow-400 to-yellow-600 text-transparent bg-clip-text">Breakroom</span>
                    </a>
                    ...
                    <div class="hidden md:flex space-x-6">
                        ...
                        <a href="#" class="hover:text-yellow-400 transition-colors">Events</a>
                        <a href="#" class="hover:text-yellow-400 transition-colors">Menu</a>
                    </div>
                </div>
                        ...
                        <div class="hidden absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-lg border border-gray-700" id="user-menu">
                            <div class="py-1">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="block w-full text-left px-4 py-2 hover:bg-gray-700 text-red-400">Logout</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <div class="pt-24 pb-12 px-4 max-w-screen-xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div class="bg-gradient-to-br from-purple-900 to-purple-800 p-6 rounded-xl shadow-lg hover:scale-105 transition-transform">
                ...
                <a href="{{ route('user.tables') }}" class="inline-block bg-purple-700 hover:bg-purple-600 text-white px-4 py-2 rounded-lg transition-colors">Book Table</a>
            </div>
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="relative group">
                    <div class="absolute inset-0 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-xl opacity-50 group-hover:opacity-75 transition-opacity -rotate-1"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-gray-800/50 backdrop-blur rounded-xl p-6 shadow-lg">
                ...
                <img src="/api/placeholder/400/200" alt="Menu Preview" class="w-full h-48 object-cover rounded-lg mb-4"/>
                <p class="text-gray-300 mb-4">Hungry? Check out our menu with delicious options to fuel your game.</p>
                <a href="#" class="text-yellow-400 hover:text-yellow-300">View Menu →</a>
            </div>
            
            <!-- Tournament Schedule -->
            <div class="bg-gray-800/50 backdrop-blur rounded-xl p-6 shadow-lg">
                <h3 class="text-xl font-semibold mb-4">Upcoming Tournaments</h3>
                <img src="/api/placeholder/400/200" alt="Tournament Preview" class="w-full h-48 object-cover rounded-lg mb-4"/>
                <p class="text-gray-300 mb-4">Join our weekly tournaments and compete for amazing prizes!</p>
                <a href="#" class="text-yellow-400 hover:text-yellow-300">View Schedule →</a>
            </div>
        </div>
    </div>
        ...
        <div class="max-w-screen-xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">Your premium billiard destination for casual games and professional tournaments.</p>
                </div>
                <div>
