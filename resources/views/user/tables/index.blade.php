        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        ...
                        <!-- Dropdown Menu -->
                        <div class="hidden absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-lg border border-gray-700 z-50" id="user-menu">
                            <div class="py-1">
                                <a href="{{ route('user.profile') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-yellow-400">
                                    Profile Settings
                                </a>
                                <a href="#" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-yellow-400">
                                    Booking History
                                </a>
                                <a href="#" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-yellow-400">
                                    Loyalty Points
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="block w-full text-left px-4 py-2 text-sm text-red-400 hover:bg-gray-700">
                                        Sign out
                                    </button>
                                </form>
                            </div>
                    ...
                    <!-- Mobile menu button -->
                    <button type="button" class="md:hidden bg-gray-800 p-2 rounded-md focus:outline-none" id="mobile-menu-button">
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="hidden md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1">
                    <a href="{{ route('dashboard') }}" class="block text-gray-300 hover:text-yellow-400 px-3 py-2 rounded-md">Home</a>
                    <a href="{{ route('user.tables') }}" class="block text-yellow-400 font-bold px-3 py-2 rounded-md">Tables</a>
                    <a href="#" class="block text-gray-300 hover:text-yellow-400 px-3 py-2 rounded-md">Events</a>
                    <a href="#" class="block text-gray-300 hover:text-yellow-400 px-3 py-2 rounded-md">Products</a>
                    <a href="#" class="block text-gray-300 hover:text-yellow-400 px-3 py-2 rounded-md">Food & Drinks</a>
                </div>
            </div>
        </div>
    </nav>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach ($tables as $table)
                        <div class="relative group">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-r from-yellow-400/20 to-yellow-600/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -rotate-1"></div>
