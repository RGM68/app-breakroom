...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        <h2 class="text-black text-2xl font-bold mb-6">Loyalty Program</h2>
        ...
        <p class="text-black">You have:</p>
        <div class="text-center">
            <h1 class="text-black" style="font-size: 100px">{{$user->loyalty_points}}</h1>
        </div>
        <p class="text-black text-end mb-2">Loyalty Points</p>

        <hr />

        <h2 class="text-black text-3xl text-center font-bold mb-6">Rewards</h2>

        <!-- User's Current Vouchers -->
        <div class="mt-12">
            <h2 class="text-black text-xl font-bold mb-4">Your Vouchers</h2>
                ...
                @forelse ($userVouchers as $userVoucher)
                    <div class="bg-gray-50 rounded-lg p-4 shadow-sm flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Expires: {{ $userVoucher->expires_at->format('d M Y') }}</p>
                        </div>
        ...
        <!-- Available Vouchers -->
        <h2 class="text-black text-2xl font-bold mb-6">Vouchers</h2>
                ...
                <div class="bg-gray-50 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
                    ...
                    <div class="mt-6">
                        <form action="{{ route('user.loyalty.redeem-voucher', $voucher->id) }}" method="POST">
                            @csrf
                            <button type="submit" 
                                @if($user->loyalty_points < $voucher->points_required) disabled @endif
